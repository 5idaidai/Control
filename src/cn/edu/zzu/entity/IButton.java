...
public class IButton extends JButton{
        ...
        private BufferedImage image_over;                //鼠标不在按钮上的图片
        ...
        public IButton(String pic1, String pic2, String pic3){
                mouseOn = false;
                mousePressed = false;
                //加载图片
        ...
        public static void main(String[] args) {
    		JButton button = new IButton("img/button_add.png", "img/button_add_off.png", "img/button_add_pressed.png");// 产生一个圆形按钮
